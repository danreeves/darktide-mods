...
local player_hud_def_path =
    "scripts/ui/hud/elements/personal_player_panel/hud_element_personal_player_panel_definitions"
local team_hud_settings_path = "scripts/ui/hud/elements/team_player_panel/hud_element_team_player_panel_settings"
local player_hud_settings_path =
    "scripts/ui/hud/elements/personal_player_panel/hud_element_personal_player_panel_settings"
mod:hook("require", function(func, path, ...)

    local result = func(path, ...)

    if path == player_hud_settings_path then
        result.feature_list.health_text = true
        result.feature_list.toughness_text = true
        result.feature_list.level = true
        return result
    end

    if path == team_hud_settings_path then
        result.feature_list.health_text = true
        result.feature_list.toughness_text = true
        result.feature_list.level = true
        return result
    ...
    if path == team_hud_def_path then

        result.widget_definitions.coherency_indicator = UIWidget.create_definition({{
        ...
        result.widget_definitions.numeric_ui_ammo_text = UIWidget.create_definition({{
            value_id = "text",
            style_id = "text",
            pass_type = "text",
            value = "<ammo_count>",
        ...
        result.widget_definitions.health_text = UIWidget.create_definition({{
            value_id = "text_3",
            style_id = "text_3",
            pass_type = "text",
            value = "0",
        ...
        result.widget_definitions.toughness_text = UIWidget.create_definition({{
            value_id = "text_3",
            style_id = "text_3",
            pass_type = "text",
            value = "0",
