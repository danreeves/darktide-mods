			...
			},
			{
				...
				sub_widgets = {
					...
					},
					{
						...
						type = "text",
						title = "steam_worker_url",
						tooltip = "steam_worker_url_tooltip",
						placeholder_text = "steam_worker_url_placeholder",
						default_value = "",
					},
					{
						setting_id = "xbox_worker_url",
						type = "text",
						title = "xbox_worker_url",
						tooltip = "xbox_worker_url_tooltip",
						placeholder_text = "xbox_worker_url_placeholder",
						default_value = "",
					},
					{
						setting_id = "psn_worker_url",
						type = "text",
						title = "psn_worker_url",
						tooltip = "psn_worker_url_tooltip",
						placeholder_text = "psn_worker_url_placeholder",
						default_value = "",
					},
				},
			},
