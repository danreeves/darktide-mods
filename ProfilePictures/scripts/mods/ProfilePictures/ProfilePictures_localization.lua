return {
	...
	location_player_hud_tooltip = {
		en = "The personal and team player panels, including their Mourningstar variants, and the mission notifications that show a portrait.",
		de = "Die eigene Spielerleiste und die des Teams, einschließlich ihrer Varianten auf der Mourningstar, sowie die Missionsbenachrichtigungen mit Porträt.",
		it = "Il pannello del giocatore e quelli della squadra, comprese le loro varianti sulla Mourningstar, e le notifiche di missione che mostrano un ritratto.",
		es = "Los paneles del jugador y del equipo, incluidas sus variantes en la Mourningstar, y las notificaciones de misión que muestran un retrato.",
		pl = "Panel własny i panele drużyny, w tym ich warianty na Mourningstar, oraz powiadomienia misji z portretem.",
		["pt-br"] = "Os painéis do próprio jogador e da equipe, incluindo suas variantes na Mourningstar, e as notificações de missão que exibem um retrato.",
		ja = "自分およびチームのプレイヤーパネル（モーニングスター版を含む）と、ポートレートが表示されるミッション通知。",
		ko = "본인 및 팀원 플레이어 패널(모닝스타 버전 포함)과 초상화가 표시되는 임무 알림.",
		["zh-cn"] = "个人与队伍玩家面板，包括晨星号上的版本，以及显示肖像的任务通知。",
		["zh-tw"] = "個人與隊伍玩家面板，包括晨星號上的版本，以及顯示肖像的任務通知。",
		ru = "Личная панель игрока и панели команды, включая их варианты на «Утренней звезде», а также уведомления во время задания с портретом.",
		fr = "Les panneaux du joueur et de l'équipe, y compris leurs variantes sur le Mourningstar, et les notifications de mission affichant un portrait.",
	},
